...
public final class InstallationPlan {
    ...
    private InstallationPlan(Builder b) {
        ...
        this.fv2j3VersionDir = b.fv2j3VersionDir != null ? b.fv2j3VersionDir : minecraftHome.resolve("versions").resolve(InstallerConstants.FV2J3_VERSION_ID);
        this.runtimeDir = b.runtimeDir != null ? b.runtimeDir : InstallerConstants.getRuntimeDir();
    ...
    public Path fv2j3VersionJson() { return fv2j3VersionDir.resolve(InstallerConstants.FV2J3_VERSION_ID + ".json"); }
