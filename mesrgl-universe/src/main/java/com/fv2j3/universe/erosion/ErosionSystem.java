package com.fv2j3.universe.erosion;

import com.fv2j3.universe.identifiers.ChunkCoord;
import com.fv2j3.universe.persistence.PersistentEdit;
...
public final class ErosionSystem {
    ...
    public void step(ChunkCoord coord, Chunk chunk, double flowIntensity) {
        ...
        try {
            ...
            com.fv2j3.universe.identifiers.UniverseId chunkAsId = new com.fv2j3.universe.identifiers.UniverseId(
