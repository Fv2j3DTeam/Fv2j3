package com.fv2j3.universe.planet;
...
/**
 * Real {@link com.fv2j3.universe.streaming.StreamingManager.RegionGenerator}
 ...
 */
public final class PlanetRegionGenerator implements com.fv2j3.universe.streaming.StreamingManager.RegionGenerator {
    ...
    @Override
    public com.fv2j3.universe.streaming.Region generate(
            com.fv2j3.universe.streaming.RegionKey key,
            long universeSeed,
        ...
        if (persistence != null) {
            persistence.recordEdit(com.fv2j3.universe.persistence.PersistentEdit.simple(
                    key.id(),
                    com.fv2j3.universe.persistence.PersistentEdit.Kind.DISCOVERY,
                    new byte[]{1}));
        }

        RegionContent content = new RegionContent(
                chunk, cs, floraChunk, placements, fluid, coord, planet.id());
        return new com.fv2j3.universe.streaming.Region(
                key, com.fv2j3.universe.streaming.RegionState.LOADED, content, System.currentTimeMillis());
    }

    @Override
    public long estimateBytes(com.fv2j3.universe.streaming.Region region) {
