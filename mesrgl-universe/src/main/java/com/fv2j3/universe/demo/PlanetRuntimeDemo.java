package com.fv2j3.universe.demo;

import com.fv2j3.universe.UniverseFactory;
...
public final class PlanetRuntimeDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            com.fv2j3.universe.streaming.Region region = f.get(10, TimeUnit.SECONDS);
            ...
            if (region.content() instanceof PlanetRegionGenerator.RegionContent rc) {
                ...
                // Save
                com.fv2j3.universe.error.Result<Path> save = w.persistence.save(12345L, 1);
