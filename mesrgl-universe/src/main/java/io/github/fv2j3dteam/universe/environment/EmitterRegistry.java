...
public final class EmitterRegistry {
    ...
    public List<EnvironmentalEmitter> emittersIn(io.github.fv2j3dteam.universe.identifiers.ChunkCoord coord) {
    ...
    private static long chunkKey(io.github.fv2j3dteam.universe.identifiers.ChunkCoord c) {
