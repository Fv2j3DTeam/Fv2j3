...
import io.github.fv2j3dteam.universe.environment.EnvironmentalEmitter;
...
class CoupledSystemTest {
    ...
    void fireSmokeWindCoupling() throws Exception {
        ...
        try {
            ...
            try {
                ...
                Chunk chunk = new io.github.fv2j3dteam.universe.generation.TerrainGenerator().generate(planet, c);
    ...
    void erosionReducesSurface() {
        var persistence = new io.github.fv2j3dteam.universe.persistence.PersistenceManager(
                Path.of("nonexistent-" + System.nanoTime() + ".dat"),
                new io.github.fv2j3dteam.universe.events.EventBus());
    ...
    void fullPipelineSteps() throws Exception {
        ...
        try {
            ...
            try {
                ...
                io.github.fv2j3dteam.universe.erosion.ErosionSystem erosion = new io.github.fv2j3dteam.universe.erosion.ErosionSystem(w.persistence);
