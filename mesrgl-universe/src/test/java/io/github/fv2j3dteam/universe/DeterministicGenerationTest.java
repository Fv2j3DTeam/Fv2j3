...
class DeterministicGenerationTest {
    ...
    void climateDeterministic() {
        ...
        var a = c.sample(p, new io.github.fv2j3dteam.universe.identifiers.ChunkCoord(0, 0, 0), 0, 0, 0);
        var b = c.sample(p, new io.github.fv2j3dteam.universe.identifiers.ChunkCoord(0, 0, 0), 0, 0, 0);
