            ...
            for (int x = 0; x < w; x++) {
                ...
                for (int dy = -1; dy <= 1; dy++) {
                    ...
                    for (int dx = -1; dx <= 1; dx++) {
                        ...
                        float weight = (float) Math.exp(-d2 / (2.0f * 18.0f * 18.0f));
                        sumR += (int) (r * weight);
                        sumG += (int) (g * weight);
                        sumB += (int) (b * weight);
                        sumW += weight;
                ...
                tmp.put(i,     (byte) (sumR / Math.max(1, sumW)));
                tmp.put(i + 1, (byte) (sumG / Math.max(1, sumW)));
                tmp.put(i + 2, (byte) (sumB / Math.max(1, sumW)));
